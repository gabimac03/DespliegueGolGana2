...
--
-- Host: 127.0.0.1    Database: golgana
-- ------------------------------------------------------
...
CREATE TABLE `canchas` (
  ...
  CONSTRAINT `canchas_ibfk_1` FOREIGN KEY (`IDPredio`) REFERENCES `predios` (`IDPredio`),
  CONSTRAINT `canchas_ibfk_2` FOREIGN KEY (`IDDisciplina`) REFERENCES `disciplinas` (`IDDisciplina`)
...
-- Dump completed on 2025-04-14 13:37:24
